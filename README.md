...
3. **品牌與產品線分開** —— iPhone 是產品線，對應 Apple 同實體中 adg 最高的 ID；只有已確認的母子品牌關係才採子品牌，不能只靠文字先後位置
...
2026-09-22 檢查與 Temp 分工：[交接方案](docs/temp_handoff.md)。中括號支援 `【】` 與 `[]`；品牌欄空白且無有效中括號品牌時，會掃描完整商品名稱，但配件／相容描述仍先排除。新增品牌均需人工查證，信心分數不代表核准新增。
